...
export const ProductPageTemplate = ({ title, heading, description, intro, main, testimonials, fullImage, pricing }) => (
...
`
// this query causing errors
// goes under testimonials 2 blocks up from this
// full_image {
//   childImageSharp {
